...
year <- as.character(reportYear)      ## SERVER!!!!!!
# year <- 2015                          ## LOKALT!!!!!!
# reshID <- 110734 # 110734 (Tønsberg)  ## LOKALT!!!!!!
datoFra <- paste0(year, "-01-01")
datoTil <- paste0(year, "-12-31")

RegData <- NGERHentRegData(datoFra = datoFra, datoTil = datoTil)      ## SERVER!!!!!!
...
FigAndeler(RegData=RegData, valgtVar='Alder', datoFra=datoFra, datoTil=datoTil,
           outfile='alder.pdf', reshID=reshID, enhetsUtvalg=0,
           hentData=0, preprosess=F)

FigAndeler(RegData=RegData, valgtVar='LapComplications', datoFra=datoFra, datoTil=datoTil,
           outfile='LapComplications.pdf', reshID=reshID, enhetsUtvalg=0,
           hentData=0, preprosess=F)

datoFra <- paste0(as.character(reportYear-2), "-01-01")

FigAndelTid(RegData=RegData, valgtVar='OpAntibioticProphylaxis', datoFra=datoFra, datoTil=datoTil,
           outfile='OpAntibioticProphylaxis.pdf', reshID=reshID, enhetsUtvalg=0,
           hentData=0, preprosess=F)
...
\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth]{/usr/local/lib/R/site-library/nger/alder.pdf}
\caption{Aldersfordelingen til pasientene i NGER}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth]{/usr/local/lib/R/site-library/nger/LapComplications.pdf}
\caption{Komplikasjoner ved laparoskopi}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth]{/usr/local/lib/R/site-library/nger/OpAntibioticProphylaxis.pdf}
