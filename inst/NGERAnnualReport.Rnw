...
personText <- "person"
if (tableData$personsWithMultipleCompl > 1) {
  personText <- "personer"
}

cap <- paste(cap, "I datagrunnlaget er det", tabData$personsWithMultipleCompl,
             personText, "som er registrert innen mer enn én av
