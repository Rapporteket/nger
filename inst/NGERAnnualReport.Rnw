...
\section{Pasientkarakteristika og operasjonsparameter}
Pilottabell:
<<'tabPasientegenskaper', results='asis', echo=TRUE, eval=TRUE>>=
RegData <- NGERHentRegDataVI(reportYear)
tabData <- NGERtabVI(RegData)

cap <- "Pasientkarakteristika"
tab <- xtable::xtable(tabData$tabVI, align=c("l", "l", "r", "r"),
                     digits=c(0,0,2,2),
