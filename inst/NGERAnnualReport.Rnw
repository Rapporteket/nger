...
cap <- paste(cap, "Datagrunnlaget består av", dim(RegData)[1],
             "laparoskopiforløp brukt grunnlag for beregning av andel
             komplikasjoner. I samme datagrunnlaget finnes det",
             tabData$personsWithMultipleCompl, personText,
             "som er registrert i mer enn én av",
             "komplikasjonshovedkategoriene.")
print(xtable::xtable(tabData$tabXXI, align=c("l", "r", "r"),
                     digits=c(0,0), caption=cap, label="tab:postOpLapCompl"),
