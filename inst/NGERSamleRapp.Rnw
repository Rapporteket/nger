...
utført i perioden \Sexpr{min(RegData$OpDato)} til \Sexpr{max(RegData$OpDato)}.
...
tabAvdN <- tabAntOpphShAar(RegDataHele, datoTil=datoTil)$tabAntAvd
...
#results='asis',
dum <- NGERFigFordeling(RegData=RegData, preprosess=0,datoFra=datoFra, valgtVar='Alder', datoTil=datoTil,
                      reshID=reshID, enhetsUtvalg=enhetsUtvalg, outfile='AlderFord.pdf')

dum <- NGERFigFordeling(RegData=RegData, preprosess=0,datoFra=datoFra, valgtVar='OpAnestesi', datoTil=datoTil,
...
dum <- NGERFigFordeling(RegData=RegData, preprosess=0,datoFra=datoFra, valgtVar='LapEkstrautstyr', datoTil=datoTil,
                      reshID=reshID, enhetsUtvalg=enhetsUtvalg, outfile='LapEkstrautstyr.pdf', OpMetode = 1)


dum <- NGERFigFordeling(RegData=RegData, preprosess=0,datoFra=datoFra, valgtVar='LapTeknikk', datoTil=datoTil,
...
dum <- NGERFigFordeling(RegData=RegData, preprosess=0,datoFra=datoFra, valgtVar='KomplPostopType', datoTil=datoTil,
...
dum <- NGERFigFordeling(RegData=RegData, preprosess=0,datoFra=datoFra, valgtVar='Opf0AlvorlighetsGrad', datoTil=datoTil,
...
dum <- NGERFigFordeling(RegData=RegData, preprosess=0,datoFra=datoFra, valgtVar='LapIntraabdominell', datoTil=datoTil,
                      reshID=reshID, enhetsUtvalg=enhetsUtvalg, outfile='LapIntraabdominell.pdf')

dum <- NGERFigFordeling(RegData=RegData, preprosess=0,datoFra=datoFra, valgtVar='HysKomplikasjoner', datoTil=datoTil,
...
dum <- NGERFigFordeling(RegData=RegData, preprosess=0,datoFra=datoFra, valgtVar='KomplPostUtd', datoTil=datoTil,
                      reshID=reshID, enhetsUtvalg=enhetsUtvalg, outfile='KomplPostUtd.pdf')

dum <- NGERFigFordeling(RegData=RegData, preprosess=0,datoFra=datoFra, valgtVar='KomplReopUtd', datoTil=datoTil,
