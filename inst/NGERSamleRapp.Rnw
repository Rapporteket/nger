...
DiagHys <- c('HypDiag1', 'HypDiag2', 'HypDiag3')
...
InstrTab <- plyr::daply(RegDataUtvalg[ ,Instr], .(RegDataUtvalg$SykehusNavn),colwise(sum), na.rm=T)  #Liste m/6dim
colnames(InstrTab) <- c('Morc.u/pose', 'Morc. m/pose', 'Harmoisk Scalp.', 'Portioad.', 'IntKombo', 'Robotkir.')

InstrTab <- plyr::ddply(RegDataUtvalg[ ,Instr], .(RegDataUtvalg$SykehusNavn),colwise(sum), na.rm=T)  #Dataramme m/7dim
addmargins(InstrTab, margin = 2)
@
...
dum <- NGERFigAndeler(RegData=RegData, datoFra=datoFra, valgtVar='OpAnesthetic', datoTil=datoTil,
...
dum <- NGERFigAndelTid(RegData=NGERData, datoFra=datoFra, valgtVar='KomplIntra', datoTil=datoTil,
            reshID=reshID, enhetsUtvalg=enhetsUtvalg, outfile='KomplIntraLapAar.pdf',
            minald=minald, maxald=maxald, MCEType=1,tidsenhet=tidsenhet, preprosess=0)
...
dum <- NGERFigAndelTid(RegData=NGERData, datoFra=datoFra, valgtVar='KomplPostop', datoTil=datoTil,
            reshID=reshID, enhetsUtvalg=enhetsUtvalg, outfile='KomplPostopLapAar.pdf',
            minald=minald, maxald=maxald, MCEType=1,tidsenhet=tidsenhet, preprosess=0)

dum <- NGERFigAndelTid(RegData=NGERData, datoFra=datoFra, valgtVar='KomplPostop', datoTil=datoTil,
            reshID=reshID, enhetsUtvalg=enhetsUtvalg, outfile='KomplPostopHysAar.pdf',
            minald=minald, maxald=maxald, MCEType=2, tidsenhet=tidsenhet, preprosess=0)


dum <- NGERFigAndelTid(RegData=NGERData, datoFra=datoFra, valgtVar='Opf0Reoperasjon', datoTil=datoTil,
...
\begin{figure}[ht]
  \centering \includegraphics[width= \Sexpr{figKrymp2}\textwidth]{KomplPostopLapAar.pdf}
...
dum <- NGERFigAndelerGrVar(RegData=RegData, datoFra=datoFra, datoTil=datoTil, valgtVar='KomplPostop',
            reshID=reshID, outfile='KomplPostopLapShus.pdf', MCEType=1,
            minald=minald, maxald=maxald, Hastegrad = Hastegrad, preprosess = 0)

dum <- NGERFigAndelerGrVar(RegData=RegData, datoFra=datoFra, datoTil=datoTil, valgtVar='KomplPostop',
            reshID=reshID, outfile='KomplPostopHysShus.pdf', MCEType=2,
            minald=minald, maxald=maxald, Hastegrad = Hastegrad, preprosess = 0)
...
\begin{figure}[ht]
  \centering \includegraphics[width= \Sexpr{figKrymp2}\textwidth]{KomplPostopLapShus.pdf}
  \centering \includegraphics[width= \Sexpr{figKrymp2}\textwidth]{KomplPostopHysShus.pdf}
  \caption{\label{fig:KomplPostopShus} Postoperative komplikasjoner ved registrerende enheter.}
\end{figure}
