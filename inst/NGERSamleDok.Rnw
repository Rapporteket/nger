...
%' opts_chunk$set(fig.path='figurer/nger-', fig.align='center', fig.show='hold', out.width='.7\\textwidth', cache=FALSE)
...
print(xtable::xtable(Tabell, digits=0, align=c('l', rep('r', ncol(Tabell))),
                     caption='Liste over avdelinger som registrerer pasienter i NGER.',
                     label='tab:RegistrenrendeAvd'),
