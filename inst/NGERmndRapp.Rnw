...
variabler <- c('Opf0KomplBlodning')
              #  , 'Opf0KomplUtstyr', 'Opf0KomplInfeksjon', 'Opf0KomplOrgan', 'Opf0Reoperasjon',
...
for (valgtVar in variabler) {
	...
	nger::NGERFigAndelTid(RegData=RegData, # datoFra=datoFra, datoTil=datoTil,
	                      valgtVar=valgtVar,
