...
nger::NGERFigKvalInd(RegData=NGERData, preprosess=0, reshID=0,
                     valgtVar='kvalInd',
...
<<'AntMnd', results='asis'>>=
antMnd <- 6
xtable::xtable(nger::tabAntOpphShMnd(RegData=NGERData, datoTil = Sys.Date(), antMnd=antMnd, reshID=reshID),
               digits=0,
