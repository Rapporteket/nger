...
nger::NGERFigKvalInd(RegData=RegData, preprosess=0, reshID=reshID, outfile='KvalIndPros.pdf')
@

<<'LageFig', include=FALSE>>=
# nger::NGERFigKvalInd(RegData=RegData, reshID=reshID, datoFra=datoFra, datoTil=datoTil,
#                              valgtVar='kvalInd', enhetsUtvalg=1,
#                              preprosess=0, outfile='KvalIndPros.pdf')
...
for (valgtVar in variable) {
	...
	nger::NGERFigAndelerGrVar(RegData=RegData, valgtVar=valgtVar, preprosess=0, datoFra=datoFra,
                datoTil=datoTil, outfile=outfile, reshID=reshID, enhetsUtvalg=1)
}
