...
rm(list=ls())
NGERBasis <- read.table('C:/Registre/NGER/data/AlleVarNum2016-10-10.csv', sep=';', header=T, fileEncoding = 'UTF-8') #,
NGERForlop <- read.table('C:/Registre/NGER/data/ForlopsOversikt2016-10-10.csv', sep=';', header=T, fileEncoding = 'UTF-8')
NGEROppf <- read.table('C:/Registre/NGER/data/FollowupsNum2016-10-10.csv', sep=';', header=T, fileEncoding = 'UTF-8')
