...
setwd('/home/rstudio/speil/NGERaarsrapp' ) #"P:/Registerinfo og historie/NGER/aarsrapp/")
...
aarsRappAar <- 2021
datoFra <- paste0(aarsRappAar, '-01-01')
...
RegData <- NGERPreprosess(RegData = NGERRegDataSQL(datoFra = datoFra, datoTil = datoTil))
